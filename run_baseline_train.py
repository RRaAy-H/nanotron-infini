#!/usr/bin/env python3
"""
Baseline training script - identical to run_train.py but for baseline configuration.

Usage:
```
export CUDA_DEVICE_MAX_CONNECTIONS=1
torchrun --nproc_per_node=4 run_baseline_train.py --config-file baseline_config.yaml
```
"""
import argparse
