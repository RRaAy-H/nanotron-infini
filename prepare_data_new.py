#!/usr/bin/env python
# filepath: /Users/zhang/Desktop/huawei/infi_llama/nanotron-infini/prepare_data_new.py
...
def main():
    parser = argparse.ArgumentParser(description="Prepare data for Infini-Llama training")
    parser.add_argument("--input-dir", type=str, default="/data1/dataset/HuggingFaceFW", 
                        help="Directory containing the raw parquet files")
    parser.add_argument("--output-dir", type=str, default="/data1/dataset/HuggingFaceFW/processed",
