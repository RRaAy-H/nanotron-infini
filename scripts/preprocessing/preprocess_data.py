#!/usr/bin/env python
# filepath: /Users/zhang/Desktop/huawei/infi_llama/nanotron-infini/scripts/preprocessing/preprocess_data.py

"""
Data preprocessing script for Infini-Llama training.
...
Usage:
```
python preprocess_data.py --config-file custom_infini_config_gpu.yaml --output-dir processed_data
python preprocess_data.py --config-file custom_infini_config_gpu.yaml --output-dir processed_data --gpu-id 1
python preprocess_data.py --config-file custom_infini_config_gpu.yaml --output-dir processed_data --no-gpu
```
"""
...
def preprocess_dataset(
    ...
    metadata = {
        "timestamp": timestamp,
        "config_file": trainer.config_file,
