...
CHECKPOINT_PATH="${1}"
CONTEXT_LENGTH="${2:-2048}"
GPU_ID="${3:-6}"
OUTPUT_FILE="${4:-eval_2048.json}"
...
for i in "${!depth_percentages[@]}"; do
    ...
    CUDA_VISIBLE_DEVICES=$GPU_ID CUDA_DEVICE_MAX_CONNECTIONS=1 torchrun --nproc_per_node=1 /data1/infini-attn/baseline/nanotron-infini/examples/infinite-context-length/run_evals.py \
